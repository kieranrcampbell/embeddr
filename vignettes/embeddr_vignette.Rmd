...
```{r heatmap,  fig.width=8.5,fig.height=6, message=FALSE, cache=TRUE}
...
```{r neighbour-choice,  fig.width=8, fig.height=6, cache=TRUE}
...
```{r subsample-robust, cache=TRUE, fig.width=8, fig.height=8}
ncv <- 8
...
```{r subsample-robust-3, cache=TRUE, fig.width=8, fig.height=3 }
ncv <- 3
...
```{r plot-modules, fig.width=2.5, fig.height=8, cache=TRUE, message=FALSE}
n_cuts <- 6
