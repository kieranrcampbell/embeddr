...
plot_pseudotime_density(lsce_13_tmp)
```
...
print(intersect(markers2, pseudotime_markers_at2))
print(setdiff(markers2, pseudotime_markers_at2))
print(setdiff(pseudotime_markers_at2, markers2))
...
print(intersect(markers1, pseudotime_markers_at1))
print(setdiff(markers1, pseudotime_markers_at1))
print(setdiff(pseudotime_markers_at1, markers1))

all_at2 <- union(pseudotime_markers_at2_upreg, pseudotime_markers_at2)
print(intersect(markers2, all_at2))
print(setdiff(markers2, all_at2))
print(setdiff(all_at2, markers2))
```
...
agree_2 <- intersect(all_at2, markers2)

paper_only_1 <- setdiff(markers1, pseudotime_markers_at1)
paper_only_2 <- setdiff(markers2, all_at2)

embeddr_only_1 <- setdiff(pseudotime_markers_at1, markers1)
embeddr_only_2 <- setdiff(all_at2, markers2)
