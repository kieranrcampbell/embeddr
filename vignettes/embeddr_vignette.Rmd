...
```{r embedding_highmag, cache=TRUE, fig.align='center', fig.width=7.5, fig.height=4.5}
set.seed(123)
...
```{r clust_emb, cache=TRUE, fig.align='center', fig.width=7.5, fig.height=4.5}
...
```{r cont2, fig.align='center', cache=TRUE, message=FALSE, warning=FALSE, fig.height=4.5, fig.width=6}
