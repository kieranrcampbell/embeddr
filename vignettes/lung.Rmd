...
M_bp_at1 <- filter(M, cluster %in% 1:2, component_1 > 0.04)
...
bp_at1 <- M$cluster %in% 1:2 & M$component_1 > 0.04
...
M_bp_at2 <- filter(M, cluster %in% 2:3, component_1 > 0.04)
...
bp_at2 <- M$cluster %in% 2:3 & M$component_1 > 0.04
