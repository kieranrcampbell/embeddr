...
plot_pseudotime_model(lsce_sig)
```
...
# plot_spanning_tree(lcds2, color_by = 'cluster')
# 
# cds_at_bp1 <- lcds2[,lcds$cluster %in% c('BP','AT1')]
# cds_at_bp1 <- reduceDimension(cds_at_bp1, use_irlba=FALSE)
# cds_at_bp1 <- orderCells(cds_at_bp1, num_paths = 1)
# plot_spanning_tree(cds_at_bp1, color_by = 'cluster')
# 
